#!/usr/bin/env python3
"""
Recuperation des codes promo Lookfantastic depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/lookfantastic.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/lookfantastic.fr"
STORE_NAME = "Lookfantastic"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Lookfantastic depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-lookfantastic)"
    }
    try:
